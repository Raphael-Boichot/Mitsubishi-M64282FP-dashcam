...
//https://github.com/bitbank2/PNGenc for png support
...
void png_upscaler(char image_data[], int w, int h, int scale_factor, char output[]) {

  int WIDTH = w * scale_factor;
  int HEIGHT = h * scale_factor;
  int rc, iDataSize, x, y, index;
  byte ucLine[WIDTH];
  byte pixel;
