...
void loop()
{
  ...
  //nigth mode strategy
//  if (current_exposure = 0xFFFF) exposure_multiplier = exposure_multiplier + 1;
//  if (current_exposure < 0xA000) exposure_multiplier = exposure_multiplier - 1;
//  if (current_exposure = 0) exposure_multiplier = 1;
