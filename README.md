...
- [Andreas Hahn](https://github.com/HerrZatacke) for the fruitful technical dicussions, the [dithering pattern generator](https://herrzatacke.github.io/dither-pattern-gen/) and the [Powershell scripts](https://github.com/Raphael-Boichot/Mitsubishi-M64282FP-dashcam/tree/main/SD) and the [colorscale generator](https://github.com/HerrZatacke/gradient-values).
