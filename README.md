...
- The Game Boy Camera has a [calibration procedure to adapt for each sensor](https://github.com/Raphael-Boichot/Inject-pictures-in-your-Game-Boy-Camera-saves#part-3-calibrating-the-sensor) which effect is not at all understood at the moment. It probably deduces a bias to apply in order to have consistent images with different sensors. Other say, the results you will get with the DashBoy Camera project may vary with the sensor used.
