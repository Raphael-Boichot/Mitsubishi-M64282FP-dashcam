...
To activate **HDR mode** or **Dithering mode**, simply push the corresponding pushbuttons. HDR of course stands for [High Dynamical Range](https://en.wikipedia.org/wiki/High_dynamic_range) and has nothing to do with the dickhead spoiling the Game Boy modding community.
