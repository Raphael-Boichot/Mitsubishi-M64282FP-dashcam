...
- The M64282FP sensor is known to have been massively produced for use in the Game Boy Camera. No known old new stocks or other use have been found on the internet. On the other hand, the M64283FP was produced but no device using it is known at the moment. Old new stocks sometimes appears. Both chips are strictly pinout compatible and very probably directly software back compatible. One line of mobile phone (LaPochee) has used one of these sensor but it's unclear which without any tear down.
