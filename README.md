...
- **Focus peaking** allows embossing the area with the best exposure as focusing with such low definition can sometimes be tricky. Very practical if you [couple the device with a CS mount](https://www.thingiverse.com/thing:5024326), as the focusing plan can be tricky to find with such low definition !
