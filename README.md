...
- The M64283FP has an automatic black level calibration ("clamping circuit") supposed to be active by default by using the same P, M and X registers as a Game Boy Camera. My notes about that are in comments into the code. Honestly, I do not see any obvious effect by activating/deactivating it.
