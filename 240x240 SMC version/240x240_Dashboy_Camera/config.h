...
char dithering_strategy[] = {2, 1, 1, 1, 1, 1}; //2 for regular strategy, 0 for Dithering_patterns_low, 1 Dithering_patterns_high, from low to high exposure times
...
unsigned char regular_v_min = 45; //minimal voltage returned by the sensor in 8 bits DEC (0.58 volts)
unsigned char regular_v_max = 236;//maximal voltage returned by the sensor in 8 bits DEC (3.04 volts)
////////////////////////
